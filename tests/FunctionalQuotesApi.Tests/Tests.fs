...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> FunctionalQuotesApi.App.configureApp)
        .ConfigureServices(Action<IServiceCollection> FunctionalQuotesApi.App.configureServices)
